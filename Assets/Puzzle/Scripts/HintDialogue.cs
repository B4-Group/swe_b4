...
enum PuzzleType
{
    Calculater, SimonSays, Information
}
...
public class HintDialogue : MonoBehaviour
{
    ...
    {
        this.puzzleType = (PuzzleType)puzzleType;
    }
        ...
        if (content == null)
        {
            switch (puzzleType)
            {
                ...
                case PuzzleType.SimonSays:
                    hintText.text = "Um dieses Puzzle zu lösen, musst du drei mal das richtige Symbole anklicken. Welches Symbol als nächstes dran ist, wird dir auf der rechten Seite angezeigt.\nAchtung: du hast nur 5 Sekunden Zeit um ein Symbol auszuwählen!";
                    break;
